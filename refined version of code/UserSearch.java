			...
			ArrayList<mainItem>  Itemss=new ArrayList<>();
			 ...
			 for(int o=0;o<Itemss.size();o++) {
				 if(ids.get(index)==Itemss.get(o).productID) {
						...
						if(index==1)result=result+"{\"productID\":"+Itemss.get(o).productID+",\"category\":\""+Itemss.get(o).category+"\",\"name\":\""+Itemss.get(o).name+"\",\"brand\":"+brand+",\"stores\":"+store+",\"price\":"+price+",\"description\":"+description+"}";
						else result=result+","+"{\"productID\":"+Itemss.get(o).productID+",\"category\":\""+Itemss.get(o).category+"\",\"name\":\""+Itemss.get(o).name+"\",\"brand\":"+brand+",\"stores\":"+store+",\"price\":"+price+",\"description\":"+description+"}";
					// return result;
						///here

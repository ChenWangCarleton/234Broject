...
public class ClientConnection extends Thread {
	...
	private void sendMultiple(String IDs, DataOutputStream outToClient) {
		...
		ArrayList<String> source = new ArrayList<>();
		source.add("bin/sample/LoblawsWithBrand.json");
		source.add("bin/sample/IndependentWithBrand.json");
		source.add("bin/sample/WalmartWithBrand.json");
		String target = "bin/sample/Main.json";
		UserSearch us = new UserSearch(source, target);

...
public class ClientConnection extends Thread {
	...
	public void run() {
		...
		//If request contains commas then send multiple Products
	...
	//Purpose: Send All products to client
	...
	//Purpose: Send one product to client
	...
	//Purpose: Send Multiple products to client
	...
	//Purpose: Used to write to byte stream  
	...
	//Purpose: Determine whether the client wants ALL products,One product or Multiple products

        ...
        while (true) {
            ...
            if (!initialized) {      
                ...
                initialized = true;
                  ...
                  System.out.println("Server: Waiting for packet2."); 
...
//		IndependentForJson i =new IndependentForJson("IndependentForJson.txt");
//		LobLawsForJson lb=new LobLawsForJson("LoblawsForJson.txt");
////		
//		independentTxtToJson ijson=new independentTxtToJson("IndependentForJson.txt","IndependentJson.json");
//		loblawsTxtToJson lbjson=new loblawsTxtToJson("LoblawsForJson.txt","LoblawsJson.json");
//		
//		
//		
//		ArrayList<String> source = new ArrayList<>();
//		source.add("LoblawsJson.json");
//		source.add("IndependentJson.json");
//		String target="MainJson.json";

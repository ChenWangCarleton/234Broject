...
//	Document document;
	...
	public LobLaws() throws IOException {
		target=new File("D:\\LoblawsItems.txt");
		target.delete();
		pw=new PrintWriter(new FileWriter(target));
		String first="/Food/";
		String source= "";
		FirstLevel(source,first);
	/*	String second="/Food/Fruits-%26-Vegetables/";
		String source="/Food/Fruits-%26-Vegetables/c/LSL001001000000";
		SecondLevel(source,second);*/
	}
...
/*		Document doc1=Jsoup.connect(head+source+hl).get();
	...
	//	System.out.println("SIZE:   "+products.size());
		...
		//	System.out.println(blank+blank+blank+products.keySet().toArray()[x]+"    price:  "+products.get(products.keySet().toArray()[x]));
			pw.println(blank+blank+blank+products.keySet().toArray()[x]+"    price:  "+products.get(products.keySet().toArray()[x]));
			pw.flush();
		}
